...
if (isset($_POST['sub'])) {
    ...
    $de = mysqli_real_escape_string($con, $_POST['des']);
    ...
    $sql = "INSERT INTO games (game_name, discription, img) VALUES ('$name', '$de', '$img')";
...
<div class="fr">
    ...
    <input type="text" name="name" placeholder="Game Name" class="text"><br>
    <textarea type="text" name="des" placeholder="Description" class="text"></textarea><br>
